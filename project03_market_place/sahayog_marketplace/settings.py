...
WSGI_APPLICATION = 'sahayog_marketplace.wsgi.application'
...
# Use Redis URL from environment if available (for Render), otherwise use localhost
...
# Convert Redis URL to tuple format for Channels (REDIS_URL already defined above)
...
FORCE_SCRIPT_NAME = os.getenv('FORCE_SCRIPT_NAME', '/marketplace') or None
