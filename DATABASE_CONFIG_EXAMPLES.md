...
## 2. sahayog_marketplace/sahayog_marketplace/settings.py
...
## 4. Update SECRET_KEY in sahayog_marketplace

In `sahayog_marketplace/sahayog_marketplace/settings.py`, replace the hardcoded SECRET_KEY (line 11) with:
